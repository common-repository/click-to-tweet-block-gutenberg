 ...
 * Description: Engage your readers and grow your audience using the CoBlocks Click to Tweet Block. CoBlocks is a suite of professional content blocks for the upcoming WordPress Gutenberg block editor. Our blocks are hyper-focused on empowering content marketers, writers and publishers to write beautifully rich content in WordPress.
 * Author: Rich Tabor from CoBlocks
 * Author URI: https://coblocks.com
 * Tags: gutenberg, editor, block, twitter, tweet
 * Version: 1.1.0
 * Text Domain: 'click-to-tweet-gutenberg'
 * Domain Path: languages
 * Tested up to: 4.9.7
 *
 * CoBlocks Click to Tweet Block is distributed in the hope that it will be useful,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
 * GNU General Public License for more details.
 *
 * You should have received a copy of the GNU General Public License
 * along with CoBlocks Click to Tweet Block. If not, see <http://www.gnu.org/licenses/>.
 *
 * @package   CoBlocks Click to Tweet Block
 * @author    Rich Tabor from CoBlocks
 * @license   GPL-3.0
 */
...
/**
 * Main CoBlocks Click to Tweet Block Class
 *
 * @since 1.0.0
 */
class CoBlocks_Click_To_Tweet {
	...
	public function plugin_action_links( $actions ) {
		...
		$title = esc_html__( 'Get CoBlocks', 'click-to-tweet-gutenberg' );
	...
	public function plugin_row_meta( $input, $file ) {
		...
		$links = array(
			'<a href="' . esc_url( $url ) . '" target="_blank">' . esc_html__( 'More blocks', 'click-to-tweet-gutenberg' ) . '</a>',
		);
